...
// Source: github.com/Di-nis/shortener-url/internal/repository (interfaces: WriteCloser,ReadCloser)
...
func (m *MockWriteCloser) Write(arg0 models.URLBase) error {
	m.ctrl.T.Helper()
...
func (m *MockReadCloser) Load() ([]models.URLBase, error) {
	m.ctrl.T.Helper()
...
func (mr *MockReadCloserMockRecorder) Load() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Load", reflect.TypeOf((*MockReadCloser)(nil).Load))
}
